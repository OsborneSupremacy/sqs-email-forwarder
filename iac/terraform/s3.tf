...
resource "aws_s3_bucket" "bro-ses-inbox-staged" {
  bucket = "bro-ses-inbox-staged"
}
...
resource "aws_s3_bucket_lifecycle_configuration" "ses_inbox_staged_lifecycle" {
  bucket = aws_s3_bucket.bro-ses-inbox-staged.id
